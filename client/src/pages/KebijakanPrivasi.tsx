    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        <div className="border-b border-[#E9E9EA] py-6">
          <h1 className="text-center text-2xl md:text-3xl">Kebijakan Privasi</h1>
        </div>
          ...
          <div className="container mx-auto px-4 sm:px-10 lg:px-20 xl:px-30">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-12">
                <div>
                  <h2 className="text-2xl md:text-3xl mb-4">1. Pendahuluan</h2>
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl mb-4">2. Data yang Kami Kumpulkan</h2>
                  <p className="text-sm text-[#6F6F71] leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl mb-4">3. Cara Kami Menggunakan Data</h2>
                  <p className="text-sm text-[#6F6F71] leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl mb-4">4. Pembagian Data kepada Pihak Ketiga</h2>
                  <p className="text-sm text-[#6F6F71] leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl mb-4">5. Keamanan Data</h2>
                  <p className="text-sm text-[#6F6F71] leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl mb-4">6. Penyimpanan Lokal &amp; Cookie</h2>
                  <p className="text-sm text-[#6F6F71] leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl mb-4">7. Hak Anda atas Data Pribadi</h2>
                  <p className="text-sm text-[#6F6F71] leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl mb-4">8. Retensi Data</h2>
                  <p className="text-sm text-[#6F6F71] leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl mb-4">9. Perubahan Kebijakan</h2>
                  <p className="text-sm text-[#6F6F71] leading-relaxed">
