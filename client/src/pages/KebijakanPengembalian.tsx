        ...
        <section className="py-16">
          <div className="container mx-auto px-4 sm:px-10 lg:px-20 xl:px-30">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-3xl md:text-5xl font-normal leading-tight text-[#1e1e1e] mb-4">Kebijakan Pengembalian</h1>
              <p className="text-sm text-black/60 mb-12">Terakhir diperbarui: 10 Juli 2026</p>
              <div className="space-y-10">
                <div>
                  <h2 className="text-2xl md:text-3xl font-normal text-black leading-tight mb-4">1. Ketentuan Umum</h2>
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl font-normal text-black leading-tight mb-4">2. Jangka Waktu Pengajuan</h2>
                  <p className="text-lg text-black/80 leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl font-normal text-black leading-tight mb-4">3. Syarat Pengajuan</h2>
                  <p className="text-lg text-black/80 leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl font-normal text-black leading-tight mb-4">4. Jenis Pengajuan: Komplain vs Retur</h2>
                  <p className="text-lg text-black/80 leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl font-normal text-black leading-tight mb-4">5. Alur Proses Pengajuan</h2>
                  <p className="text-lg text-black/80 leading-relaxed">
                    Setelah pengajuan dikirim, status akan berjalan sebagai berikut:
                  </p>
                  <ol className="list-decimal pl-6 text-lg text-black/80 leading-relaxed space-y-2 mt-4">
                    <li>"Menunggu"</li>
                    <li>"Diproses"</li>
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl font-normal text-black leading-tight mb-4">6. Pengiriman Barang Retur</h2>
                  <p className="text-lg text-black/80 leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl font-normal text-black leading-tight mb-4">7. Opsi Resolusi</h2>
                  <p className="text-lg text-black/80 leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl font-normal text-black leading-tight mb-4">8. Pengecualian</h2>
                  <p className="text-lg text-black/80 leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl md:text-3xl font-normal text-black leading-tight mb-4">9. Pembatalan Sebelum Pengiriman</h2>
                  <p className="text-lg text-black/80 leading-relaxed">
